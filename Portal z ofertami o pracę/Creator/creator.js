...
function validateData() {
  if (browserDefaultLanguage.includes('pl')) {
    ...
    validateInputValue(
      telRegEx,
      telInput.value,
      'Telefon: +XX XXX XXX XXX lub podobnie.'
    );
    validateInputValue(
      dateRegEx,
      birthInput.value,
      'Data: YYYY-MM-DD lub podobnie.'
    );
    validateInputValue(nameRegEx, nameInput.value, 'Imię: 3-30 liter/cyfr.');
    validateInputValue(
      nameRegEx,
      surnameInput.value,
      'Nazwisko: 3-30 liter/cyfr.'
    );
  ...
  validateInputValue(
    telRegEx,
    telInput.value,
    'Phone: +XX XXX XXX XXX or similar.'
  );
  validateInputValue(
    dateRegEx,
    birthInput.value,
